...
typedef struct
{
    ...
    uint8_t maxMetaElements_u8;                 /*! max metadata elements supported*/
    uint8_t maxTelemetryElements_u8;            /*! max telemetry elements supported*/
    uint8_t maxCommands_u8;                     /*! max commands supported*/
