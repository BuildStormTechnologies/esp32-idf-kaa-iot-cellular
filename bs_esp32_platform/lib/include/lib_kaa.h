 ...
 */
bool KAA_subscribe(char *pTopicStr, uint8_t qos_e);
 ...
 */
bool KAA_publish(mqttMsg_st *ps_msg);
 ...
 */
bool KAA_read(mqttMsg_st *ps_msg);
 ...
 * @returns none
 */
void KAA_printStatus();

void KAA_restart();
const char *KAA_getThingName();
